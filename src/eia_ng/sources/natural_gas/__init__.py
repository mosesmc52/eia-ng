...
from .consumption import NaturalGasConsumption
from .storage import NaturalGasStorage


class NaturalGas(BaseSource):
    def __init__(self, client):
        super().__init__(client, base_endpoint="natural-gas/")
        self.storage = NaturalGasStorage(client)
        self.consumption = NaturalGasConsumption(client)
